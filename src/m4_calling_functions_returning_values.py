...
def run_test_sum_of_digits():
    ...
    # -------------------------------------------------------------------------
    expected = 23
    answer = sum_of_digits(8834)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    expected = 17
    answer = sum_of_digits(89)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    expected = 16
    answer = sum_of_digits(1111111111111111)
...
def sum_of_digits(number):
    ...
    while True:
        ...
        number = number // 10 # 7/3= 2.R,   7//3=2,  7%3=R
...
def run_test_fancy_sums_of_digits():
    ...
    print('       actual:  ', answer)
    expected = 141922
    answer = fancy_sums_of_digits(62)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
